...
function generateVoucherCode(orderId: string) {
...
export default function OrderConfirmation() {
  ...
  useEffect(() => {
    ...
    if (rawTotal) {
      const total = Number(rawTotal) / 100;
      setTotalINR(total);
      setOrderTotal(`₹${total.toLocaleString("en-IN")}`);
    }
    if (rawId) {
      setVoucherCode(generateVoucherCode(rawId));
    }
  }, []);

  const showVoucher = totalINR >= 1500;
    ...
    >
      <div style={cardStyle}>
        ...
        <div style={{ textAlign: "center" }}>
          ...
          >
            {showVoucher ? "DIGITAL LUCKY VOUCHER CARD" : "ORDER CONFIRMATION"}
          </div>
          <hr style={dividerStyle} />
        </div>
        ...
        {showVoucher ? (
          <>
            ...
            >
              ...
              <div>
                ...
                >
                  Thank you for shopping with Meet Enterprises. You have
                  received a{" "}
            ...
            <div style={termBoxStyle}>
              ...
              >
                <li>
                  This voucher is issued only on minimum purchase of ₹1500 from
                  Meet Enterprises.
                </li>
                <li>
                ...
                <li>
                  Winning voucher codes will be randomly selected and announced
                  on our website.
                </li>
                <li>
                  Winners must present the{" "}
                  <strong style={{ color: GOLD }}>original voucher code</strong>{" "}
                  to claim the prize.
                </li>
                <li>
                ...
                <li>
                  Meet Enterprises reserves the right to modify or cancel the
                  scheme if required.
                </li>
              </ol>
            </div>
          ...
          /* ── Below ₹1500: Simple confirmation + reminder ── */
          <>
            {/* Success message */}
            <div
              style={{
            ...
            >
              ...
              <div>
                ...
                >
                  Thank you for shopping with Meet Enterprises. Your order is
                  confirmed.
                </p>
              </div>
            </div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                ...
                {orderTotal && (
                  ...
                  >
                    ...
                    <span
                      style={{ color: GOLD, fontWeight: 700, fontSize: 13 }}
                    >
                      {orderTotal}
                    </span>
                  </div>
            ...
            {/* Voucher reminder banner */}
            <div
              data-ocid="order_confirmation.voucher_reminder.panel"
              style={{
                border: `2px solid ${GOLD}`,
                background: "rgba(212,175,55,0.08)",
                borderRadius: 6,
            ...
            >
              ...
              >
                Shop for{" "}
                <span style={{ color: GOLD, fontWeight: 900, fontSize: 14 }}>
                  ₹1,500 or more
                </span>{" "}
                to earn a{" "}
                <span style={{ color: GOLD, fontWeight: 700 }}>
                ...
                on your next order and get a chance to win prizes up to ₹10,000!
              </p>
              <div
                style={{
                  marginTop: 12,
              ...
              >
                Minimum purchase of ₹1,500 required to receive a voucher
              </div>
            </div>
          </>
        )}
